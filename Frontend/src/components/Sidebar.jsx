...
export default function Sidebar({
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      // Clear token / stored state from browser storage
    ...
    >
        ...
        {historyList.map((item) => {
          ...
          return (
            <div
              ...
              className={`group relative p-3 rounded-xl cursor-pointer transition-all flex flex-col gap-1 ${
                isSelected
      ...
      <div className="p-3 space-y-2 border-t border-white/5">
        ...
        <button
          ...
          className="w-full py-2 rounded-lg bg-red-600/80 hover:bg-red-600 transition text-sm font-medium disabled:opacity-50 flex items-center justify-center gap-2"
        >
          {isLoggingOut ? (
